...
dewebd tx staking create-validator \
  ...
  ```
  ## Domain
  dewebd tx domain register crypto --data="$BasicData" --from $WALLET --chain-id $DWS_CHAIN_ID --fees 250udws --output json -b block
  ## Peer list
   ```bash
